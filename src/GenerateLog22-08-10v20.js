...
const scriptVersion = "22-08-10 v20";
      ...
      for (let lastPlacedEntry of myContentGroupLastPlacedArray) {
        ...
        for (var i = 0; i < thisItemRecords.length; ++i) {
            ...
            if (thisItemUpdated < 0) {
                output.markdown ("                  Item: . . . . " + " Item: " + thisItemRecord.getCellValueAsString("Item Name"));
            } else {
                output.markdown ("                  Item: " + convertHMS(thisItemUpdated) + " Item: " + thisItemRecord.getCellValueAsString("Item Name"));
            }
        }
    }
    output.markdown ("=====================================================");
