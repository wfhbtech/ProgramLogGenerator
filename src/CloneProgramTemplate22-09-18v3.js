...
const scriptName = 'CloneProgramTemplate';
const scriptVersion = '22-09-18 v3';
...
// Clone a Program Template along with its Program Template Details record set
    ...
    if (sourceTemplateRecord.id === templateDetailsProgramTemplateLink) {
        ...
        clonedRecords.push({
            fields: {
                ...
                Optional: templateDetailsRecord.getCellValue('Optional'),
            },
        });
    }
}
