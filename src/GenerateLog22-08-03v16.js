...
const scriptVersion = "22-08-03 v16";
...
/*   
    Generate Logs - read the Sync Broadcast Schedule instead of the Day Template and Day Template details
*/
    ...
    */
    ...
    LogEntries: for (let logEntry of logEntries.records) {
      ...
      ContentGroups: for (let contentGroupsRecord of contentGroups.records) {
        ...
        debugMsg(
          "At top of placement group loop with group=" + thisPlacementGroup
        );
