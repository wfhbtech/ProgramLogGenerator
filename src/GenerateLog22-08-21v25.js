...
const scriptVersion = "22-08-21 v25";
...
output.markdown("# Expanding Program Templates for today's broadcast schedule");
...
debugMsg('parametersRecord: ', parametersRecord);
infoMsg ("Trace Placement Group: " + tracePlacementGroup + " Trace Content Item: " + traceContentItem + " Trace Number: " + traceLevel); 
await generateLog();
